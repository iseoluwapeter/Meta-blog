...
const Navbar = () => {
  ...
  const [darkMode, setDakMode] = useState(false);
  ...
  return (
      ...
      <nav className="my-4  bg-white dark:bg-black dark:text-white sticky top-0  ">
          ...
          <div className="hidden lg:flex  gap-[40px]">
            ...
            <div className="hidden lg:block">
              ...
              <button
                ...
                className=" bg-[#e8e8ea] rounded-full  ps-2 pe-4  py-2 text-2xl"
              >
